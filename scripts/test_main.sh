# #!/bin/bash
# rm -rf logs/gpu_logs/7b_test_1234.log
# # # Start logging GPU usage in the background
# while true; do
#     nvidia-smi >> logs/gpu_logs/7b_test_1234.log
...
#exp_root="/home/qianxi/scratch/laffi/code/results/test2/filename_2024-04-22_13-08-29"
# for i in {0..2};
# do 
...
CUDA_VISIBLE_DEVICES=0 python /home/qianxi/scratch/laffi/code/main.py \
                                ...
                                --enable_squad_eval=0 \
                                --enable_gsm8k_eval=0 \
                                --enable_natural_ins=0 \
                                --enable_initial_human_examples=1 \
                                --enable_mismatch_initial_human_examples=0 \
                                --eval_inference_batch_size=2 \
                                --experiment_root_path=$exp_root \
                                --per_task_data_rows=50 \
                                --cur_iteration=0 \
                                --na_ins_evalset_path="/home/qianxi/scratch/laffi/datasets/natural_instruction_v1/converted/natural_ins_eval_official_converted.json" \
                                --num_return_seq=1
