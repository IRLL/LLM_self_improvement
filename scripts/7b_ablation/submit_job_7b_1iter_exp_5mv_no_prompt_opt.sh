#!/bin/bash
#SBATCH --job-name=ablation_5_mv_no_opt
#SBATCH --nodes=1
...
CUDA_VISIBLE_DEVICES=0 python /home/qianxi/scratch/laffi/code/main.py \
                                ...
                                --enable_squad_eval=0 \
                                --enable_gsm8k_eval=1 \
                                --enable_prompt_optimization=0 \
                                --num_return_seq=$1 \
                                --experiment_root_path="/home/qianxi/scratch/laffi/code/results/official_experiment/7b/ablation/no_prompt_opt/" \
