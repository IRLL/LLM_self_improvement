#!/bin/bash
#SBATCH --job-name=ablation_corrupt
#SBATCH --nodes=1
...
CUDA_VISIBLE_DEVICES=0 python /home/qianxi/scratch/laffi/code/main.py \
                                ...
                                --enable_gsm8k_eval=1 \
                                --num_return_seq=$1 \
                                --enable_mismatch_initial_human_examples=1 \
                                --experiment_root_path="/home/qianxi/scratch/laffi/code/results/official_experiment/7b/ablation/corrupted_examples" \
