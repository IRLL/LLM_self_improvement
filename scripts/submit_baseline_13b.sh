...
CUDA_VISIBLE_DEVICES=0,1 python /home/qianxi/scratch/laffi/code/sft.py \
                                --model_path="/home/qianxi/scratch/laffi/models/13b" \
                                --experiment_root_path="/home/qianxi/scratch/laffi/code/results/baselines/13b/2" --baseline_only=1